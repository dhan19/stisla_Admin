...
mix.babel('node_modules/izitoast/dist/js/iziToast.min.js',
 ...
 mix.js('resources/assets/js/trucks/trucks.js', 'public/assets/js/trucks/trucks.js').version();


 mix.js('resources/assets/js/user_details/user_details.js', 'public/assets/js/user_details/user_details.js').version();


 mix.js('resources/assets/js/drivers/drivers.js', 'public/assets/js/drivers/drivers.js').version();
